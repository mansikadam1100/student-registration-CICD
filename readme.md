...
![](./img/Screenshot%202025-11-09%20182241.png)
...
![](./img/Screenshot%202025-11-07%20181336.png)
...
![](./img/Screenshot%202025-11-07%20190020.png)
...
pipeline {
    ...
    stages {
        stage('Clone Repo') {
            steps {
                git url: 'https://github.com/mansikadam1100/python-app.git', branch: 'main'
            }
        }
...
![](./img/Screenshot%202025-11-06%20165108.png)
![](./img/Screenshot%202025-11-06%20164426.png)
